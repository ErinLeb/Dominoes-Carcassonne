...
public abstract class GamePanel<S extends Side, T extends Tile<S>> extends JPanel {
    ...
    protected void initInformationElements() {
        ...
        constraints.gridx = 0;
        constraints.gridy = 8;
        nbTiles.setIcon(GraphicalImageSetter.initImageAsImageIcon("resources/bag.png"));
    ...
    protected void initTurnButtons() {
        ...
        turnLeftButton.setIcon(GraphicalImageSetter.initImageAsImageIcon("resources/turn_left.png"));
        ...
        turnRightButton.setIcon(GraphicalImageSetter.initImageAsImageIcon("resources/turn_right.png"));
    ...
    protected abstract class Board<U extends TilePanel> extends JPanel {

        protected U[] tiles = (U[]) new TilePanel[25]; // Change to TileDominoGui
